...
class Game:
    ...
    def event_discard(self, player_number, card_id):
        ...
        self.get_new_card(player_number, card_id)
        time.sleep(3)
        self.next_turn()

    def event_play(self, player_number, card_id):
    ...
    def get_new_card(self, player_number, card_id):
        ...
        index = self.players_cards[player_number].index(card_id)
        self.players_cards[player_number][index] = new_card
